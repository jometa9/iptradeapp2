...
// Provider component
export const UnifiedAccountDataProvider: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => {
...
export const useUnifiedAccountDataContext = () => {
  ...
  if (!context) {
    throw new Error(
      'useUnifiedAccountDataContext must be used within a UnifiedAccountDataProvider'
    );
  }
  return context;
};
