...
function generatePendingAccounts(count = 8) {
  ...
  for (let i = 0; i < count; i++) {
    ...
    // Crear contenido CSV
    const csvContent = createPendingAccountCSV(accountId, platform, broker, accountType);

    // Nombre del archivo
    const fileName = `account_${accountId}.csv`;
  ...
  console.log(`\n📁 Archivos creados en: ${accountsDir}`);
  console.log(`\n🔄 El servidor debería detectar automáticamente estos archivos CSV.`);
